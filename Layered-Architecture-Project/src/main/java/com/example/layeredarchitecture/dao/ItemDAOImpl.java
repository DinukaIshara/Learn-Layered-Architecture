...
public class ItemDAOImpl implements ItemDAO {
    ...
    public ArrayList<ItemDTO> getAllItems() throws SQLException, ClassNotFoundException {
        ...
        while (rst.next()) {
            ...
            ItemDTO item = new ItemDTO(id,description,price,qty);
    ...
    @Override
    public boolean updateItem(ItemDTO item, int one) throws SQLException, ClassNotFoundException {
        Connection connection = DBConnection.getDbConnection().getConnection();
        PreparedStatement pstm = connection.prepareStatement("UPDATE Item SET description=?, unitPrice=?, qtyOnHand=? WHERE code=?");
    ...
    @Override
    public String getNextCode() throws SQLException, ClassNotFoundException {
        Connection connection = DBConnection.getDbConnection().getConnection();
